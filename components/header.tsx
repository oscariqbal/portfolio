...
export default function Header() {
    return (
        ...
        <nav className='h-[50%] font-heading container mx-auto bg-foreground/10 backdrop-blur-sm rounded-xl pl-5 border border-foreground/15'>
          <ul className='h-full w-full flex items-center gap-6'>
            ...
            <li><a className="hover:text-muted-foreground" href='#case-study'>Case Study</a></li>
