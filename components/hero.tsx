...
export default function Hero() {
  return (
    <section id='hero' className='h-[75vh] md:h-[80vh] w-[90vw] md:w-[85vw] mx-auto flex flex-col gap-4 border border-red-500'>
      ...
      <div className="justify-center flex gap-4 md:gap-6 lg:gap-8 text-center border border-blue-500">
        ...
        <Button size={"sm"} variant={"outline"} className="cursor-pointer font-heading text-xs sm:text-sm md:text-base md:h-9 md:gap-1.5 md:px-4">Get in Touch</Button>
      </div>
    </section>
  );
}
