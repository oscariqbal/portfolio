...
export default function Home() {
  return (
    <>
      {/* Experience Section */}
      <section id='experience' className='border border-red-500'>
        <div className="flex mb-6 uppercase border border-green-500">
      ...
      <section id="tech-arsenal" className="border border-red-500">
